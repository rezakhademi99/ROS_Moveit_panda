...
def square_trajectory():
    ...
    group_name = "panda_arm"  # You may need to change this to match your group name
    ...
    pose_target.orientation.x = -0.9275318977256997
    pose_target.orientation.y = -0.37374398536127645
    pose_target.orientation.z = -5.8985324052523413e-05
    pose_target.orientation.w = 9.288898619430447e-05
